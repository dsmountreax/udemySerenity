...
public class ResultCalculatorExists implements Question<String> {
    @Autowired
    private ComponentCalculator componentCalculator;

    @Override
    public String answeredBy(Actor actor){
        UserActions.isVisible(componentCalculator.getResultLabel());
        return UserActions.isTextPresent(componentCalculator.getResultLabel(),actor);
    }
}
