...
public class MyCoursesExists implements Question<Boolean> {
    @Autowired
    ComponentMoodle componentMoodle;

    @Override
    public Boolean answeredBy(Actor actor){
        return com.udemy.automation.application.ActionsUser.UserActions.isPresent(componentMoodle.getMyCourses(),actor);
    }
}
